    ...
    <div ref={searchRef} className={className}>
      <form onSubmit={handleSearchSubmit}>
        <div className="relative">
          <button
            type="submit"
            className="absolute left-3 top-1/2 z-10 -translate-y-1/2 text-primary/70 transition-colors hover:text-primary"
          ...
          <Input
            ...
            className="h-11 w-full rounded-lg border-border bg-muted/40 pl-10 pr-4 text-sm shadow-sm focus-visible:ring-primary/25"
            value={searchQuery}
            onChange={(e) => {
