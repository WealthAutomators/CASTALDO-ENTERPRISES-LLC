    ...
    <section className="py-12 md:py-16">
      <Container>
        <div className="relative overflow-hidden rounded-2xl shadow-md">
          <div className="absolute inset-0 bg-gradient-to-r from-[#0F766E] via-[#0E6E66] to-[#0B5952]" />
          <div className="absolute right-0 top-0 h-full w-1/3 bg-gradient-to-l from-secondary/15 to-transparent" />
